...
class BaseProcessor:
    ...
    def center_window(self, window, geometry=None):
        """
        Center a tkinter window on the screen.
        
        Args:
            window: The tkinter window (Toplevel or Tk)
            geometry: Optional geometry string "WxH". If None, uses window's current size.
        """
    ...
    def _create_basic_preview_dialog(self, title, geometry="700x500"):
        ...
        # Use center_window to set geometry and position
