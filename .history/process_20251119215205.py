...
class FunctionsProcessing:
    ...
    def threshold_image(self, image):
        ...
        # Variables for threshold settings allaway int value
        ...
        thresh_scale = ttk.Scale(controls_frame, from_=0, to=255, variable=thresh_value, orient=tk.HORIZONTAL, length=300)
