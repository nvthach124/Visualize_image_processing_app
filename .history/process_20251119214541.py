...
class FunctionsProcessing:
    ...
    def __init__(self, pil_image_module, pil_image_tk_module):
        """
        Nhận các mô-đun PIL từ bên ngoài (Dependency Injection).
        Điều này làm cho class này độc lập với việc import PIL.
        """
    ...
    # --- CÁC HÀM CÓ DIALOG CỦA BẠN (ĐÃ SỬA LỖI IMPORT PIL) ---
    ...
    def threshold_image(self, image):
        ...
        thresh_scale = ttk.Frame(controls_frame, from_=0, to=255, variable=thresh_value, orient=tk.HORIZONTAL)
        ...
        max_scale = ttk.Frame(controls_frame, from_=0, to=255, variable=max_value, orient=tk.HORIZONTAL)
    ...
    def move_image(self, image):
        # ... (Code của bạn không đổi, ngoại trừ việc sửa PIL) ...
        result = None
        dialog = tk.Toplevel()
    ...
    # --- CÁC HÀM VẼ (ĐÃ SỬA LỖI IMPORT PIL) ---
    ...
    def _create_basic_preview_dialog(self, title, geometry="700x500"):
        """Hàm trợ giúp tạo dialog xem trước cơ bản."""
        dialog = tk.Toplevel()
        dialog.title(title)
    ...
    def _update_preview_canvas(self, canvas, image, original_image):
        """Hàm trợ giúp cập nhật canvas xem trước."""
        try:
    ...
    def gaussian_blur_dialog(self, image):
        """Dialog mới cho Gaussian Blur với thanh trượt."""
        result = None
    ...
    def median_blur_dialog(self, image):
        """Dialog mới cho Median Blur với thanh trượt."""
        result = None
    ...
    def morph_operations_dialog(self, image):
        """Dialog mới cho các phép toán Hình thái học."""
        result = None
