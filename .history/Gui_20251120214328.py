...
from process_refactored import FunctionsProcessing  # <-- Refactored import
import os
import cv2
...
class GUI:
    ...
    def setUpGUI(self):
        ...
        self.canvas = Canvas(canvas_container, width=1000, height=600, bg="#dddddd", 
    ...
    def apply_transformation(self, transformation):
        ...
        # === CẬP NHẬT FUNC_MAP ===
        func_map = {
            "Negative"    : self.fp.cvt_Negative     ,
            "Gray"   : self.fp.cvt_GRAY    ,
            "HSV"    : self.fp.cvt_HSV     ,
            ...
            "Histogram Viewer"    : self.fp.histogram_viewer_dialog,
        }
        # ===========================
